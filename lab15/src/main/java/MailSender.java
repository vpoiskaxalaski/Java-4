...
public class MailSender {
    public static void sendEmail(Session session, String toEmail, String subject, String body){
        try
        {
            ...
            msg.setFrom(new InternetAddress("asavchuk001@gmail.com", "Aliona Savchuk"));//("test.java.1999@gmail.com", "Aliona Savchuk"));
           // msg.setReplyTo(InternetAddress.parse("test.java.1999@gmail.com", false));
